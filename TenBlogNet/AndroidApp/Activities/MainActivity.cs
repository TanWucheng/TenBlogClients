...
using TenBlogNet.AndroidApp.Fragments;
using TenBlogNet.AndroidApp.Listeners;
using TenBlogNet.AndroidApp.RssSubscriber.Models;
using TenBlogNet.AndroidApp.Services;
using TenBlogNet.AndroidApp.Utils;
using TenBlogNet.AndroidApp.Widgets;
using Xamarin.Essentials;
using PermissionStatus = Plugin.Permissions.Abstractions.PermissionStatus;
using Toolbar = AndroidX.AppCompat.Widget.Toolbar;

namespace TenBlogNet.AndroidApp.Activities
{
